...
const BackgroundCircles = (props: Props) => {
  return (
    ...
    >
      ...
      <div className="rounded-full absolute border border-[#333333]  h-[500px] w-[500px] mt-60 animate-ping " />
      <div className="rounded-full border border-[#F7AB0A] opacity-20 h-[650px] w-[650px] absolute mt-60 animate-pulse " />
      <div className="rounded-full absolute border border-[#333333]  h-[800px] w-[800px] mt-60 animate-ping " />
    </motion.div>
  );
};
